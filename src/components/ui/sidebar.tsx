...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0 is load-bearing. This is a flex child, and a flex item
        // defaults to min-width:auto — it refuses to shrink below its content,
        // so one wide table widened the whole inset and pushed it over the
        // sidebar. Without this, an `overflow-x-auto` inside never engages,
        // because the container is always as wide as its contents.
