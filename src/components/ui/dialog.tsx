...
/**
 * A dialog's body. It is `sm:max-w-lg` wide by default because most dialogs
 * here hold a form, and a narrower one turns four fields into a column tall
 * enough to scroll. Anything that wants more room says so — the product form
 * is `sm:max-w-2xl` and pairs its short fields — and a confirmation, which is
 * one sentence and two buttons, says `sm:max-w-md`.
 */
